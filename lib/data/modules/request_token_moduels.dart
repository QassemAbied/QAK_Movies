...
class RequestTokenModules extends RequestTokenEntities{
  RequestTokenModules({required bool success, required String request_token, required String expires_at})
      : super(success: success, request_token: request_token, expires_at: expires_at);
