...
class CheckAccountStatesModules extends CheckAccountStates{
  CheckAccountStatesModules({required int id, required bool watchlist, required bool rated,
    required bool favorite}) : super(id: id, watchlist: watchlist, rated: rated, favorite: favorite);
