...
class FavoritesModules extends FavoritesEntities{
  FavoritesModules({required int page, required List<MovieEntities> results,
    required int total_pages, required int total_results}) : super(page: page,
      results: results, total_pages: total_pages, total_results: total_results);
