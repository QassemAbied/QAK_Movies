...
import 'package:untitled3/domain/use_case/watchlist_use_case/check_added_watchlist_usecase.dart';
...
class WatchlistBloc extends Bloc<WatchlistEvent , WatchlistState>{
  ...
  WatchlistBloc(this.watchListUseCase,
      this.addWatchListUseCase,
    ...
    on<GetWatchListItemsEvent>((event, emit)async {
      ...
      result.fold((l) {
        emit(state.copyWith(status: WatchlistRequestStatus.error , message:  l.message));
      }, (r) {
