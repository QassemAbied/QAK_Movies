...
class MovieDetailsState extends Equatable {
  ...
  MovieDetailsState copyWith({
    ...
    return MovieDetailsState(
      ...
      enumRequestimageMovie:
          enumRequestimageMovie ?? this.enumRequestimageMovie,
      ...
      enumRequestsimilarMovie:
          enumRequestsimilarMovie ?? this.enumRequestsimilarMovie,
      messagesimilarMovie: messagesimilarMovie ?? this.messagesimilarMovie,
      checkaccount: checkaccount ?? this.checkaccount,
      enumRequestcheckaccount:
          enumRequestcheckaccount ?? this.enumRequestcheckaccount,
