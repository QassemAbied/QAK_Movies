      ...
      builder: (context, state) {
        return Scaffold(
          body: ConditionalBuilder(
            condition: state.popularData.isNotEmpty &&
                state.movieByGenreData.isNotEmpty &&
                    ...
                    Padding(
                      ...
                      child: (Column(
                        ...
                        children: [
                              ...
                              TextButton(
                                onPressed: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => BuildListViewScreen(
                          ...
                          BuildListView(
                            movielist: state.movieByGenreData,
                          ),
                          const SizedBox(
                            height: 60,
                          ),
