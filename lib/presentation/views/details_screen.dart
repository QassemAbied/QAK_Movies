                ...
                return GestureDetector(
                  onTap: () async {
                    BlocProvider.of<MovieDetailsBloc>(context)
                      ..add(VideoMovieEvent(widget.item!.id));
                    ...
                    builder: (context, state) {
                      return Row(
                        children: [
                          IconButton(
                              onPressed: () {
                                state.checkaccount!.watchlist == false
                              ...
                              icon: Icon(
                                Icons.bookmark,
                                color: state.checkaccount?.watchlist == true
                                    ? Colors.red
                                    : Colors.black,
                                size: 40,
                              )),
                          IconButton(
                              ...
                              icon: Icon(
                                Icons.favorite,
                                color: state.checkaccount?.favorite == true
                                    ? Colors.red
                                    : Colors.black,
                                size: 40,
                              )),
        ...
        return CachedNetworkImage(
          ...
          placeholder: (context, value) {
            return Container(
              child: const Image(
                image:
                    AssetImage('assets/image/86075-loading-upload-image.gif'),
              ),
            );
          },
        );
            ...
            CachedNetworkImage(
              ...
              errorWidget: (context, value, child) {
                return Container(
                  ...
                  width: 130,
                  child:
                      Image(image: AssetImage('assets/image/no-pictures.png')),
                );
              },
              placeholder: (context, value) {
                return Container(
                      ...
                      CachedNetworkImage(
                        ...
                        errorWidget: (context, value, child) {
                          return Container(
                            ...
                            child: Image(
                                image:
                                    AssetImage('assets/image/no-pictures.png')),
                          );
                        },
                      ),
                      Padding(
              ...
              child: Row(
                children: [
                  ...
                  Container(
                      ...
                      child: Image(
                          image: AssetImage(
                              'assets/image/104878-data-not-found (1).gif'))),
                ],
              ),
            ),
          ),
