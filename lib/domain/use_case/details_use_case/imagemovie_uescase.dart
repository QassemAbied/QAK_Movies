...
class getImageMovieUseCase extends BaseUseCase<List<ImageMovieEntities> , ImageMovieId>{
  final BaseRepository baseRepository;
  getImageMovieUseCase(this.baseRepository);
  @override
  Future<Either<Failure, List<ImageMovieEntities>>> call(ImageMovieId parameter)async {
