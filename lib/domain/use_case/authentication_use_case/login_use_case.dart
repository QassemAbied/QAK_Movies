...
class getLoginValidateUseCase extends BaseUseCase<RequestTokenEntities , LoginEntities>{
  final AuthenticationRepository authenticationRepository;
  getLoginValidateUseCase(this.authenticationRepository);
  @override
  Future<Either<Failure, RequestTokenEntities>> call(LoginEntities parameter) async{
