...
import '../use_case/details_use_case/check_account_usecase.dart';
import '../use_case/details_use_case/detail_usecase.dart';
...
import '../use_case/details_use_case/video_use_case.dart';

abstract class BaseRepository
{
   Future<Either<Failure , List<MovieEntities>>> getPopularMovies();
   Future<Either<Failure , List<GenreEntities>>> getGenreMovies();
   Future<Either<Failure , List<MovieEntities>>> getMoviesByGenres(GenreId parameter);
   ...
   Future<Either<Failure , List<ImageMovieEntities>>> getImageMovies(ImageMovieId parameter);
   Future<Either<Failure , List<CastEntities>>> getCastMovies(CastMovieId parameter);
   Future<Either<Failure , List<MovieEntities>>> getSimilarMovies(SimilarId parameter);
   Future<Either<Failure , List<MovieEntities>>> getSearchMovies(SearchValue parameter);
   Future<Either<Failure , CheckAccountStates>> getCheckAccountStates(int parameter);
