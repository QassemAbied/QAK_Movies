...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<MovieModel> watchListMovies,  bool hasMor)?  success,TResult Function( String error)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
return success(_that.watchListMovies,_that.hasMor);case Error() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<MovieModel> watchListMovies,  bool hasMor)  success,required TResult Function( String error)  error,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case Loading():
return loading();case Success():
return success(_that.watchListMovies,_that.hasMor);case Error():
return error(_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<MovieModel> watchListMovies,  bool hasMor)?  success,TResult? Function( String error)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
...
class Success implements WatchListState {
  const Success({required final  List<MovieModel> watchListMovies, required this.hasMor}): _watchListMovies = watchListMovies;
  

 final  List<MovieModel> _watchListMovies;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Success&&const DeepCollectionEquality().equals(other._watchListMovies, _watchListMovies)&&(identical(other.hasMor, hasMor) || other.hasMor == hasMor));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_watchListMovies),hasMor);

@override
String toString() {
  return 'WatchListState.success(watchListMovies: $watchListMovies, hasMor: $hasMor)';
}
...
@useResult
$Res call({
 List<MovieModel> watchListMovies, bool hasMor
});
...
/// Create a copy of WatchListState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? watchListMovies = null,Object? hasMor = null,}) {
  return _then(Success(
watchListMovies: null == watchListMovies ? _self._watchListMovies : watchListMovies // ignore: cast_nullable_to_non_nullable
...
@override
String toString() {
  return 'WatchListState.error(error: $error)';
}
