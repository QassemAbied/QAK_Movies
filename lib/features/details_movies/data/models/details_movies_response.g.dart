...
part of 'details_movies_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

DetailsMoviesResponse _$DetailsMoviesResponseFromJson(
...
Map<String, dynamic> _$DetailsMoviesResponseToJson(
  DetailsMoviesResponse instance,
) => <String, dynamic>{
...
Genres _$GenresFromJson(Map<String, dynamic> json) =>
    Genres(id: (json['id'] as num?)?.toInt(), name: json['name'] as String?);
