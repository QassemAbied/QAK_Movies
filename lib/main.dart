...
void main() async{
  ...
  Hive.registerAdapter(MadiaAdapter());
  ...
  runApp(
     MultiBlocProvider(
       providers: [
         ...
         BlocProvider(create: (context)=>Sl<AuthenticationBloc>()..add(RequestTokenEvent()) ),
         BlocProvider(
         create: (context) => Sl<FavoritesBloc>()),
         BlocProvider(
             create: (BuildContext context)=>Sl<MovieBloc>()..add(PopularEvent())
               ..add(GenreEvent())
